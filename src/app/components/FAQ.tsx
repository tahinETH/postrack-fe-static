...
const faqs = [
  {
    ...
    answer:
      ...
      "Postrack tracks granular first-hour engagement patterns invisible to X Analytics, then provide AI-powered strategies to replicate viral moments and avoid dead-end posts.",
  },
  {
    question: "How is this better than X Analytics?",
    answer:
      "X shows you what happened. Postrack shows you why it happened—and how to make it happen again. For not only your account but any public account or post. " +
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-10 text-center items-center mx-auto flex justify-center">
          <p className="text-gray-600 dark:text-gray-400">
            Have more questions? <a href="mailto:info@postrack.ai" className="text-amber-600 dark:text-amber-400 font-medium hover:underline">Contact our support team</a>
          </p>
        </div>
      </div>
    </section>
